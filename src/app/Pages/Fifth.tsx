      ...
      <div className="-mt-32 min-h-[600px] px-4">
        ...
        <div className="flex flex-row gap-7 justify-center w-auto h-auto mx-auto">
          {cards.map((card, index) => (
            <div key={index} className="relative w-full max-w-[350px] h-[600px] group">
              {/* تصویر پس‌زمینه */}
              <div className="absolute w-full z-0 left-72 top-[300px] opacity-0 group-hover:opacity-80
              ...
              {/* کارت */}
              <div className="relative bg-white rounded-lg shadow-md p-6 h-[410px]
              ...
              transform group-hover:shadow-lg z-10">
                ...
                <p className="font-[IRANSans] mb-9 text-gray-400 text-lg">
                  {card.date}
                    ...
                    <button className="relative bg-purple-500 text-white font-[IRANSans]
                      py-4 px-12 rounded-lg overflow-hidden transition-all duration-300">
                      <span className="relative z-10">شروع کنید</span>
                      <span className="absolute top-0 left-0 w-full h-full bg-red-500 transform 
                      -translate-x-full transition-transform duration-300 ease-in-out group-hover:translate-x-0"></span>
                  </button>
