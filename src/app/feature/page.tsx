...
function Feature() {
  ...
  // رندر موبایل
  const renderMobile = () => (
    <div className="flex flex-col justify-center items-center px-4 max-w-md mx-auto mt-28 mb-24">
      <Image src={best} alt="best" className="w-full max-w-xs mx-auto mb-6" />
      <p className="text-xl sm:text-2xl font-bold font-[IRANSans] text-right w-full mb-16 mt-8">
        چرا آوامین بهترین انتخاب شماست؟
      </p>
