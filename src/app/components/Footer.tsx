  ...
  const renderMobile = () => (
    <div className="relative h-auto w-full font-[IRANSans] py-6">
      ...
      <div className="flex flex-col items-center text-center space-y-6">
        ...
        <div className="flex items-center space-x-2">
          <button className="bg-pink-500 px-6 py-2 rounded-3xl text-white">
            تماس با ما
          </button>
          <Image src={shap} alt="shap" className="w-6 h-6" />
        </div>
      </div>

      {/* Divider */}
      <div className="w-full h-px bg-pink-500 my-4" />
        ...
        <div className="bg-white w-full h-auto py-6">
          <div className="flex flex-col space-y-8 justify-center items-center text-center">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <h1 className="font-medium text-gray-400 w-40">
                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                استفاده از طراحان گرافیک است
              </h1>
            </div>
            ...
            <div className="flex flex-col items-center text-center space-y-3">
              <h1 className="font-bold text-base">خبرنامه</h1>
              <h1 className="font-medium text-gray-400 w-40">
                هفته ای یک مقاله آموزشی برای شما ارسال خواهیم کرد
              </h1>
              <div className="flex flex-row-reverse items-center space-x-2">
                <input className="w-24 py-1 px-4 border" />
                <button className="bg-purple-600 px-4 py-2">
